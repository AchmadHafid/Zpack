...
inline val Context.isInstalledFromPlayStore
    get() = "com.android.vending" == installerPackageName

inline val Context.isDebuggable
    get() = 0 != applicationInfo.flags and ApplicationInfo.FLAG_DEBUGGABLE

inline val isRunningInsideEmulator
